...
def get_electron_beam_parameters_from_at(id=1, verbose=0):
    if verbose:
        print("Retrieving electron beam parameters at the center of the ID%02d straight section" % id)
    ...
    if verbose:
        print("%s s: %f m" % (ID, s_locs))

    # get circumference
    Circumference = AT_LATTICE.get_s_pos(at.End)
    if verbose:
        print("Circumference, Cell", Circumference, Circumference / 32)

    # define break locations
    if verbose:
        print("Lattice location s_locs: ", s_locs)
...
class OWEBS(OWWidget):
    ...
    def __init__(self):
        ...
        gui.comboBox(self.tab_sou, self, "ebs_id_index", label="Load ID parameters from database list: ",
                     labelWidth=350,
                     items=self.get_id_list(), callback=self.set_id, sendSelectedValue=False, orientation="horizontal")

        self.electron_beam_box = oasysgui.widgetBox(self.tab_sou, "Electron Beam/Machine Parameters", addSpace=False,
                                                    orientation="vertical")

        oasysgui.lineEdit(self.electron_beam_box, self, "electron_energy_in_GeV", "Energy [GeV]", labelWidth=260,
                          valueType=float, orientation="horizontal", callback=self.update)
        oasysgui.lineEdit(self.electron_beam_box, self, "electron_energy_spread", "Energy Spread", labelWidth=260,
                          valueType=float, orientation="horizontal", callback=self.update)
        oasysgui.lineEdit(self.electron_beam_box, self, "ring_current", "Ring Current [A]", labelWidth=260,
                          valueType=float, orientation="horizontal", callback=self.update)
        ...
        self.left_box_2_1 = oasysgui.widgetBox(self.electron_beam_box, "", addSpace=False, orientation="vertical",
                                               height=150)
        ...
        oasysgui.lineEdit(tmp1, self, "moment_xx", "<x x>   [m^2]", labelWidth=100, valueType=float,
                          orientation="horizontal", callback=self.update)
        oasysgui.lineEdit(tmp1, self, "moment_xxp", "<x x'>  [m.rad]", labelWidth=100, valueType=float,
                          orientation="horizontal", callback=self.update)
        oasysgui.lineEdit(tmp1, self, "moment_xpxp", "<x' x'> [rad^2]", labelWidth=100, valueType=float,
                          orientation="horizontal", callback=self.update)
        oasysgui.lineEdit(tmp2, self, "moment_yy", "<y y>   [m^2]", labelWidth=100, valueType=float,
                          orientation="horizontal", callback=self.update)
        oasysgui.lineEdit(tmp2, self, "moment_yyp", "<y y'>  [m.rad]", labelWidth=100, valueType=float,
                          orientation="horizontal", callback=self.update)
        oasysgui.lineEdit(tmp2, self, "moment_ypyp", "<y' y'> [rad^2]", labelWidth=100, valueType=float,
                          orientation="horizontal", callback=self.update)
        ...
        self.left_box_2_2 = oasysgui.widgetBox(self.electron_beam_box, "", addSpace=False, orientation="vertical",
                                               height=150)

        oasysgui.lineEdit(self.left_box_2_2, self, "electron_beam_size_h", "Horizontal Beam Size \u03c3x [m]",
                          labelWidth=260, valueType=float, orientation="horizontal", callback=self.update)
        oasysgui.lineEdit(self.left_box_2_2, self, "electron_beam_size_v", "Vertical Beam Size \u03c3y [m]",
                          labelWidth=260, valueType=float, orientation="horizontal", callback=self.update)
        oasysgui.lineEdit(self.left_box_2_2, self, "electron_beam_divergence_h",
                          "Horizontal Beam Divergence \u03c3'x [rad]", labelWidth=260, valueType=float,
                          orientation="horizontal", callback=self.update)
        oasysgui.lineEdit(self.left_box_2_2, self, "electron_beam_divergence_v",
                          "Vertical Beam Divergence \u03c3'y [rad]", labelWidth=260, valueType=float,
                          orientation="horizontal", callback=self.update)
        ...
        oasysgui.lineEdit(self.left_box_2_3_l, self, "electron_beam_emittance_h", "\u03B5x [m.rad]", labelWidth=75,
                          valueType=float, orientation="horizontal", callback=self.update)
        oasysgui.lineEdit(self.left_box_2_3_l, self, "electron_beam_alpha_h", "\u03B1x", labelWidth=75, valueType=float,
                          orientation="horizontal", callback=self.update)
        oasysgui.lineEdit(self.left_box_2_3_l, self, "electron_beam_beta_h", "\u03B2x [m]", labelWidth=75,
                          valueType=float, orientation="horizontal", callback=self.update)
        oasysgui.lineEdit(self.left_box_2_3_l, self, "electron_beam_eta_h", "\u03B7x", labelWidth=75, valueType=float,
                          orientation="horizontal", callback=self.update)
        oasysgui.lineEdit(self.left_box_2_3_l, self, "electron_beam_etap_h", "\u03B7'x", labelWidth=75, valueType=float,
                          orientation="horizontal", callback=self.update)

        oasysgui.lineEdit(self.left_box_2_3_r, self, "electron_beam_emittance_v", "\u03B5y [m.rad]", labelWidth=75,
                          valueType=float, orientation="horizontal", callback=self.update)
        oasysgui.lineEdit(self.left_box_2_3_r, self, "electron_beam_alpha_v", "\u03B1y", labelWidth=75, valueType=float,
                          orientation="horizontal", callback=self.update)
        oasysgui.lineEdit(self.left_box_2_3_r, self, "electron_beam_beta_v", "\u03B2y [m]", labelWidth=75,
                          valueType=float, orientation="horizontal", callback=self.update)
        oasysgui.lineEdit(self.left_box_2_3_r, self, "electron_beam_eta_v", "\u03B7y", labelWidth=75, valueType=float,
                          orientation="horizontal", callback=self.update)
        oasysgui.lineEdit(self.left_box_2_3_r, self, "electron_beam_etap_v", "\u03B7'y", labelWidth=75, valueType=float,
                          orientation="horizontal", callback=self.update)
        ...
        oasysgui.lineEdit(left_box_00, self, "a0", "a0", labelWidth=260, valueType=str, orientation="horizontal",
                          callback=self.set_K)
        oasysgui.lineEdit(left_box_00, self, "a1", "a1", labelWidth=260, valueType=str, orientation="horizontal",
                          callback=self.set_K)
        oasysgui.lineEdit(left_box_00, self, "a2", "a2", labelWidth=260, valueType=str, orientation="horizontal",
                          callback=self.set_K)
        oasysgui.lineEdit(left_box_00, self, "a3", "a3", labelWidth=260, valueType=str, orientation="horizontal",
                          callback=self.set_K)
        oasysgui.lineEdit(left_box_00, self, "a4", "a4", labelWidth=260, valueType=str, orientation="horizontal",
                          callback=self.set_K)
        oasysgui.lineEdit(left_box_00, self, "a5", "a5", labelWidth=260, valueType=str, orientation="horizontal",
                          callback=self.set_K)
        oasysgui.lineEdit(left_box_00, self, "a6", "a6", labelWidth=260, valueType=str, orientation="horizontal",
                          callback=self.set_K)
    ...
    def titles(self):
        return ["K vs Gap", "B vs Gap", "Gap vs resonance energy", "Power vs Gap",
                "Power density peak at screen vs Gap"]
    ...
    def ytitles(self):
        return ['K', 'B [T]', 'Photon energy [eV]', 'Power [W]',
                'Power density peak at %2d m [W/mm$^2$]' % (self.pow_dens_screen)]
    ...
    def update_info(self):
        ...
        if self.ebs_id_index == 0:
            ...
            id = "ID%02d %s" % (
            self.data_dict["straight_section"][self.ebs_id_index - 1], self.data_dict["id_name"][self.ebs_id_index - 1])
    ...
    def plot_graph(self, plot_canvas_index, curve_name, x_values, y_values, xtitle="", ytitle="",
        ...
        self.plot_canvas[plot_canvas_index].addCurve(x_values, y_values, curve_name, symbol='', color=color,
                                                     replace=replace)  # '+', '^', ','
    ...
    def update_plots(self):
        ...
        g_k = Karray * ((Karray ** 6) + (24 / 7) * (Karray ** 4) + 4 * (Karray ** 2) + (16 / 7)) / (
                    (1 + (Karray ** 2)) ** (7 / 2))

        p_dens_peak = ((21 * (self.gamma() ** 2)) / (16 * numpy.pi * Karray) * ptot * g_k) / (
                    (self.pow_dens_screen * 1e3) ** 2)
...
"""
    ...
    def calculate_gap_from_K(self, Kvalue=None):
        ...
        if Kvalue < K_array.min():
            if ConfirmDialog.confirmed(self, message="K=%g is smaller than minimum=%g. Set to minimum?" % (
                    Kvalue, K_array.min())):
                Kvalue = K_array.min()
        ...
        if Kvalue > K_array.max():
            if ConfirmDialog.confirmed(self, message="K=%g is larger than maximum=%g. Set to maximum?" % (
                    Kvalue, K_array.max())):
                Kvalue = K_array.max()
                self.K_vertical = Kvalue
                self.populate_settings_after_setting_K()
    ...
    def send_data(self):
        try:
            self.check_data()
            self.Outputs.SynedData.send(Beamline(light_source=self.get_light_source(check_for_wiggler=True)))
            # self.send("SynedData", Beamline(light_source=self.get_light_source(check_for_wiggler=True)))
        except Exception as e:
            QMessageBox.critical(self, "Error", str(e.args[0]) if len(e.args) else str(e), QMessageBox.Ok)
        ...
        if check_elliptical:
            if "HU" in id_name:
                ConfirmDialog.confirmed(self,
                                        message="Helical/Apple undulators not implemented in this app (wrong results)")
