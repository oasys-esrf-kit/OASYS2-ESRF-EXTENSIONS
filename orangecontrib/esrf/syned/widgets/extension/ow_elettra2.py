...
class OWELETTRA2(OWWidget):
    ...
    data_url = os.path.join(resources.package_dirname("orangecontrib.esrf.syned.data"), 'elettra2_sources.csv')
    data_ls = os.path.join(resources.package_dirname("orangecontrib.esrf.syned.data"), 'Elettra_Long_Straight.json')
    data_ss = os.path.join(resources.package_dirname("orangecontrib.esrf.syned.data"), 'Elettra_Short_Straight.json')
    data_dict = None
